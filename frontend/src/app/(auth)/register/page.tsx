...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-dark-950 text-slate-100 flex items-center justify-center p-6 relative">
      {/* Decorative Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 rounded-full bg-purple-500/10 blur-[100px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-md glass-card rounded-2xl p-8 space-y-6 relative border border-slate-800">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-xl font-bold tracking-tight mt-3">Create your account</h2>
          <p className="text-xs text-slate-400">Join PlacementPro AI and start tracking your preparation</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Role selector for easy review/testing */}
          <div className="space-y-1.5">
